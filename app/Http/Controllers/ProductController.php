...
class ProductController extends Controller
{
    public function subtypes($locale, $slug){
        ...
        $untrProds = $transtype->products()->orderByRaw('number = 0, number IS NULL, number DESC')->get();
// Получение коллекции
 // Получаем коллекцию продуктов
    ...
    public function show($locale, $slug){
        ...
        $untrProduct = Product::with('subtype.parentSubtype')->where('slug', $slug)->firstOrFail();
